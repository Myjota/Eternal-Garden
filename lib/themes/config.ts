...
export const themeConfigs: Record<ThemeId, ThemeConfig> = {
  garden: {
    ...
    colors: {
      ...
      secondaryForeground: 'oklch(0.30 0.08 145)',
      accent: 'oklch(0.50 0.10 145)',
      accentForeground: 'oklch(0.98 0.005 145)',
      background: 'oklch(0.985 0.008 145)',
      foreground: 'oklch(0.22 0.03 145)',
      muted: 'oklch(0.95 0.015 145)',
      mutedForeground: 'oklch(0.48 0.05 145)',
      card: 'oklch(0.995 0.005 145)',
      cardForeground: 'oklch(0.22 0.03 145)',
