...
export function FamousSection({ t }: FamousSectionProps) {
  ...
  const currentItems = famousLithuanians.slice(
  ...
  // Placeholder images for famous Lithuanians (sepia-toned historical portraits)
    ...
    <section className="py-16 md:py-24 bg-muted/30">
      <div className="container mx-auto px-4">
        ...
        <div className="relative">
          ...
          <button
            onClick={goPrev}
            className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 z-10 w-10 h-10 rounded-full bg-primary text-primary-foreground flex items-center justify-center shadow-lg hover:bg-primary/90 transition-colors md:-translate-x-6"
            aria-label="Previous"
          >
          ...
          <button
            onClick={goNext}
            className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-4 z-10 w-10 h-10 rounded-full bg-primary text-primary-foreground flex items-center justify-center shadow-lg hover:bg-primary/90 transition-colors md:translate-x-6"
            aria-label="Next"
          >
